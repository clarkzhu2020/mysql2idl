...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.userDo.UseModel(&tables.User{})
...
func (u userDo) Create(values ...*tables.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) CreateInBatches(values []*tables.User, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userDo) Save(values ...*tables.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) First() (*tables.User, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*tables.User), nil
	}
}

func (u userDo) Take() (*tables.User, error) {
...
func (u userDo) Last() (*tables.User, error) {
...
func (u userDo) Find() ([]*tables.User, error) {
	result, err := u.DO.Find()
	return result.([]*tables.User), err
}

func (u userDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*tables.User, err error) {
	buf := make([]*tables.User, 0, batchSize)
...
func (u userDo) FindInBatches(result *[]*tables.User, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userDo) FirstOrInit() (*tables.User, error) {
...
func (u userDo) FirstOrCreate() (*tables.User, error) {
...
func (u userDo) FindByPage(offset int, limit int) (result []*tables.User, count int64, err error) {
...
func (u userDo) Delete(models ...*tables.User) (result gen.ResultInfo, err error) {
